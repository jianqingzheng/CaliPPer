...
parser.add_argument(
    "--selection_criterion",
    help="Criterion for best model selection: 'f1' or 'acc'.",
    type=str,
    default='f1',
    choices=['f1', 'acc'],
)
...
batch_size=48  # increased from 12 for faster training with 600 AA antigen
...
train(net_core=net_core, model_path=model_path,model_num=model_num,include_light=include_light, pos_path=pos_path, neg_path=neg_path, batch_size=batch_size, nb_epochs1=nb_epochs1, restore_pre_train =restore_pre_train, selection_criterion=args.selection_criterion)
